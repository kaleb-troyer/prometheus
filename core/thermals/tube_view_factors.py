# View factor between differential element on surface to tube to
# finite element on surface of adjacent tube.
# Note angles alpha (element 1) and beta (element 2) are defined
# with alpha = 0 and beta = 0 at the front tip of each tube.
