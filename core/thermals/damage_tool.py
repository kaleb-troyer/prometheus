# Goal is to make SRLIFE-generated FEA results accessible
# and useful for predicting solar receiver tube creep-fatigue
# damage and lifetime.
# 2025-07-10
# Jacob Wenner
...
class damageTool():
    ...
    def get_LTEs(self, dTs, Tfs, Rs):
        ...
        Tf - array of fluid temperatures
        ----
        returns LTE in years, depending on the material's database.
        Returns a 0 for a coordinate if that coordinate is in the
        corrosion or stress reset region.
        """
        if self.interpolator == None:
            self.make_interpolator()
