# Class for identifying corrosion velocity and temperature limits for
# solar receiver materials. Temperatures are in Celsius. Tcrit is defined
# as the maximum allowable film temperature.
#
# Sources for H230, 740H, 800H, A625, 316H: material selection for solar
# central receiver tubes by Laporte et al. (2021), which compiled other sources.
#
# 2025-04-28
# Jacob Wenner
...
class materialLimits:
    def __init__(self,mat):
        ...
        # assing a material
        if self.mat == 'A230':
            self.Tcrit = 650 # (C) source: McConohy & Kruizenga (2014)
        elif self.mat == '740H':
            ...
            self.Tcrit = 650 # (C) source: Bradshaw & Goods (2001)
        elif self.mat == 'A625':
            self.Tcrit = 630 # (C) source: Miliozzi et al. (2001)
        elif self.mat == '316H':
            self.Tcrit = 600 # (C) source: Miliozzi et al. (2001)
        elif self.mat == 'A617':
        ...
        file_string_option = f'{py_loc.parent}/dmg_tool_data/{self.mat}_SR_region.csv'
        ...
        else: raise ValueError('materialLimits class error: material not recognized')
