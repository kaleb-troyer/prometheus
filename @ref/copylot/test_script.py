...
cpath = os.path.join(os.getcwd(), 'copylot', 'climate')
cfile = 'USA CA Daggett (TMY2).csv'
...
if False:
    ...
    assert cp.data_set_string(r,
        "ambient.0.weather_file",
        os.path.join(cpath, cfile)
    )
    ...
    if plot_results:
        ...
        plt.tight_layout()
        plt.show()
    print('PASS - minimum working example')
...
if False:
    ...
    print('PASS - set / get number & boolean')
...
if False:
    ...
    print('PASS - set / get combo vars through string & number')

tpath = os.path.join(os.getcwd(), 'copylot', 'test')
afile = 'test_array.csv'
ffile = 'test_field.csv'
mfile = 'test_matrix.csv'

if False:

    ## Testing set and get array - Pass
    assert cp.data_set_array_from_csv(r, "financial.0.pmt_factors", os.path.join(tpath, afile))
...
if False:
    ...
    print('PASS - add / drop heliostat template')
...
if False:
    ...
    if test_solTrace_sim:
        ...
        if plot_results:
            ...
            plt.tight_layout()
            plt.show()
        print('PASS - SolTrace simulation')
    ...
    if True:
        ...
        if True:
            ...
            print('PASS - find max flux, change geometry, update & resimulate')
...
if True:
    ...
    print('PASS - dump_varmap and save_from')
