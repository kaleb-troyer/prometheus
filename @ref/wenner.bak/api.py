...
class Prometheus():
    ...
    def _declare_data_structures(self):
        ...
        class Files():
            ...
            casefile: str = f'{self._casename}.csv'
        ...
        class Heliostats():
            ...
            height:       float = 0.0
            ncut:         int = 0
            aiming:       list = field(default_factory=list)
            ...
            class Image():
                ...
                rel_areas: list = field(default_factory=list)
...
# model_light     # instance of therm_helpers (ch.3) thermal model
# model_heavy     # instance of therm_helpers (ch.3) thermal model
# flux_instance   # instance of sp_module member SP_Flux
# flux_dict = {}  # collection of heliostat flux-on-receiver maps, struct: {"<#id>" [[...], ...] (54x54)}
