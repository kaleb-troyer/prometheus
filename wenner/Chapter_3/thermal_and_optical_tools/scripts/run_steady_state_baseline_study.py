...
inputName = 'billboard_comparison_study_SPCS25'
...
if __name__ == "__main__":   
    case_string='Qdes'+str(model.receiver.Qdes)+'_npan'+str(model.receiver.Npanels)+'_W'+str(model.receiver.D)+'_H'+str(model.receiver.H)+'_uniform_round2'
    ...
    imgName = "./imgs/"+ "_profilesInPath_singleFlowpath_designPoint"
    print(imgName)
    ...
    helpers.make_results_file(inputString,outputString,model,d)
    ## save the most recent dTs/Tfs using alternate data processing strategy
    dTs_results, Tfs_results, qabs_results, Rs_results  =LWT_therm_mod_helpers.get_thermal_results(model.receiver)
    thermal_results={}
    ...
    csvName = '/thermal_results/stage1/'+case_string
